...
SECRET_KEY = "django-insecure-a0!+8s%x2x921n!!4!r0gw*d@$wsx6mju)aqu#9m%0s6a34op0"
...
WSGI_APPLICATION = "deliv.wsgi.application"
...
DATABASES = {
    ...
    # }
    "default": dj_database_url.parse("postgres://dire_delish_user:l5mWWAQq9sqcALNBr0acrspqbn4kLkdK@dpg-cgrf9vfdvk4n7brtcukg-a.oregon-postgres.render.com/dire_delish")
}
